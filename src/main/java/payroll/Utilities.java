...
/**
 * 22 Sep 2021 22:24:44 @Javadoc TODO
 *
...
public class Utilities {
  ...
  public static ObjectMapper mapper =
      new ObjectMapper().registerModule(new JodaModule()); // JsonUtils.getObjectMapper;

  public static <T> T createObjectFromFile(TypeReference<T> type, String filePath) {
    T value = null;

    try {
      // String responseString = new String(Files.readAllBytes(Paths.get(filePath)),
